...
logo=""" [dim white]  ____            _____         ____  ____  _____ _      ____  _     
/ ___\/  _ \/    // \  /|/  _ \/ \  /|
|    \| / \||  __\| |  ||| / \|| |\ ||
\___ || |-||| |   | |/\||| |-||| | \||
\____/\_/ \|\_/   \_/  \|\_/ \|\_/  \|                                     """
...
def main():
    ...
    print(Panel.fit("[bold green]Developer     —>>     SAFWAN ISLAM"))
    print("")
    print(meth)
...
def file_subb(Gmail,psslist):
    global oks,done
    sys.stdout.write(f"\r  \033[38;5;46m[SAFWAN-XD] {done}|{str(len(oks))}");sys.stdout.flush()
